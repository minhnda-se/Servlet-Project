        ...
        <header class="header_section">
                <div class="container">
                    <nav class="navbar navbar-expand-lg custom_nav-container ">
                        <a class="navbar-brand" href="index.html"><img width="250" src="images/logoefvfv.png" alt="#" /></a>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true"> <span class="nav-label">Platform <span class="caret"></span></a>
                                ...
                                <li class="nav-item">
                                    ...
                                    <c:if test="${not empty sessionScope.USER_ID}">
                                        <a class="nav-link" href="userInformation.jsp">
                                            <span class="fa-solid fa-user"></span>
                                        </a>
                                    </c:if>
                                </li>
