...
public class UpdateQuantityServelet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try  {
            ...
            if (!strQuantity.isEmpty() && Integer.parseInt(strQuantity) > 0) {
                    CartDAO cartDAO = new CartDAO();
                    int quantity = Integer.parseInt(strQuantity);
                    cartDAO.updateCart(quantity, userId, gameId);
            }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(UpdateQuantityServelet.class.getName()).log(Level.SEVERE, null, ex);
